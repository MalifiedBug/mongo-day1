...
//Find products which contain product color indigo  and product price 492.00 --> Query Incomplete
...
db.collection.find({
  ...
  //Delete the products which product price value are same --> not able to do
